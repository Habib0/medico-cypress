...
class patientOrdersPage extends sharedPage{
    ...
    constructor(){
        super()
            ...
            this.selectInsurance='[class="dx-bordered-bottom-view dx-datagrid-rowsview dx-datagrid-nowrap dx-scrollable dx-visibility-change-handler dx-scrollable-both dx-scrollable-simulated dx-last-row-border"]'
            this.selectPatient='[class="dx-bordered-bottom-view dx-datagrid-rowsview dx-datagrid-nowrap dx-scrollable dx-visibility-change-handler dx-scrollable-both dx-scrollable-simulated"]'
